...
var RotatingPancakeIcon = styled__default['default'](Icon$w)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var Dashboard = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    var textColor = isDark ? "none" : "#A28BD4";
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 23 23" }, props),
        React__default['default'].createElement("g", { id: "Icons_non", "data-name": "Icons/non", transform: "translate(0.5 0.5)" },
            React__default['default'].createElement("g", { id: "Group_19", "data-name": "Group 19" },
                React__default['default'].createElement("path", { fill: textColor, stroke: "#000000", strokeMiterlimit: "10", d: "M2.507,5.5H.389A.4.4,0,0,1,0,5.094V.406A.4.4,0,0,1,.389,0H2.507A.4.4,0,0,1,2.9.406V5.094A.4.4,0,0,1,2.507,5.5Z", transform: "translate(3.667 12.833)" }),
                React__default['default'].createElement("path", { fill: textColor, stroke: "#000000", strokeMiterlimit: "10", d: "M2.507,13.75H.389A.408.408,0,0,1,0,13.326V.424A.408.408,0,0,1,.389,0H2.507A.408.408,0,0,1,2.9.424v12.9A.408.408,0,0,1,2.507,13.75Z", transform: "translate(9.167 4.583)" }),
                React__default['default'].createElement("path", { fill: textColor, stroke: "#000000", strokeMiterlimit: "10", d: "M2.507,10.083H.389A.426.426,0,0,1,0,9.628V.455A.426.426,0,0,1,.389,0H2.507A.426.426,0,0,1,2.9.455V9.628A.426.426,0,0,1,2.507,10.083Z", transform: "translate(14.667 8.25)" }),
...
var Dashboard$1 = React__default['default'].memo(Dashboard, function (prev, next) { return prev.isDark === next.isDark; });
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24.262 26.809" }, props),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("clipPath", { id: "clip-path" },
                React__default['default'].createElement("path", { id: "Clip_7", "data-name": "Clip 7", fill: "none", d: "M1.929.006a.616.616,0,0,0-.478.531h0c0,.245-.007.491-.011.737h0a.187.187,0,0,1-.14.191h0A1.93,1.93,0,0,0,.014,3.625h0A1.675,1.675,0,0,0,.642,4.834h0a6.877,6.877,0,0,0,.647.433h0c.448.274.9.541,1.35.809h0a.779.779,0,0,1,.409.786h0a.766.766,0,0,1-.655.794h0a2.292,2.292,0,0,1-.63,0h0a.726.726,0,0,1-.652-.686h0a1.8,1.8,0,0,0-.075-.308h0A.5.5,0,0,0,.48,6.282h0a.506.506,0,0,0-.471.527h0A1.86,1.86,0,0,0,1.3,8.694h0a.191.191,0,0,1,.154.212h0c0,.265.015.531.035.8h0a.49.49,0,0,0,.475.47h0a.5.5,0,0,0,.575-.41h0a4.938,4.938,0,0,0,.059-.688h0c.007-.2.036-.373.287-.391h0c.008,0,.016-.008.025-.012h0a1.852,1.852,0,0,0,1.221-1.9h0a1.7,1.7,0,0,0-.872-1.615h0c-.24-.161-.492-.3-.738-.453h0c-.369-.227-.744-.447-1.1-.686h0a.765.765,0,0,1-.288-.9h0A.746.746,0,0,1,1.8,2.49h0a3.389,3.389,0,0,1,.416-.014h0a.733.733,0,0,1,.778.648h0a3.543,3.543,0,0,0,.108.432h0a.5.5,0,0,0,.559.331h0a.524.524,0,0,0,.46-.5h0a1.887,1.887,0,0,0-1.4-1.964h0c-.1-.022-.126-.062-.13-.165h0A5.44,5.44,0,0,0,2.522.4h0A.454.454,0,0,0,2.034,0h0a.979.979,0,0,0-.105.006Z", transform: "translate(0.128 0.827)" }))),
        React__default['default'].createElement("g", { id: "Icons_non", "data-name": "Icons/non", transform: "translate(0.5 0.698)" },
            React__default['default'].createElement("g", { id: "Group_14", "data-name": "Group 14", transform: "translate(-0.5 -1.5)" },
                React__default['default'].createElement("g", { id: "Group_5", "data-name": "Group 5", transform: "translate(0 0.591)" },
                    React__default['default'].createElement("path", { id: "Stroke_1", "data-name": "Stroke 1", fill: "none", stroke: "#000000", strokeLinecap: "round", strokeMiterlimit: "10", strokeLinejoin: "round", d: "M0,10.09c-.006-.08,8.845-5.856,8.845-5.856l4.3,2.444L22.262,0", transform: "translate(0.5 0.91)" }),
                    React__default['default'].createElement("path", { id: "Stroke_3", "data-name": "Stroke 3", fill: "none", stroke: "#000000", strokeLinecap: "round", strokeMiterlimit: "10", strokeLinejoin: "round", d: "M0,0H4.7V4.538", transform: "translate(18.066 0.909)" })),
                React__default['default'].createElement("g", { id: "Group_8", "data-name": "Group 8", transform: "translate(14 13.591)" },
                    React__default['default'].createElement("path", { id: "Clip_7-2", "data-name": "Clip 7", fill: "none", d: "M1.929.006a.616.616,0,0,0-.478.531h0c0,.245-.007.491-.011.737h0a.187.187,0,0,1-.14.191h0A1.93,1.93,0,0,0,.014,3.625h0A1.675,1.675,0,0,0,.642,4.834h0a6.877,6.877,0,0,0,.647.433h0c.448.274.9.541,1.35.809h0a.779.779,0,0,1,.409.786h0a.766.766,0,0,1-.655.794h0a2.292,2.292,0,0,1-.63,0h0a.726.726,0,0,1-.652-.686h0a1.8,1.8,0,0,0-.075-.308h0A.5.5,0,0,0,.48,6.282h0a.506.506,0,0,0-.471.527h0A1.86,1.86,0,0,0,1.3,8.694h0a.191.191,0,0,1,.154.212h0c0,.265.015.531.035.8h0a.49.49,0,0,0,.475.47h0a.5.5,0,0,0,.575-.41h0a4.938,4.938,0,0,0,.059-.688h0c.007-.2.036-.373.287-.391h0c.008,0,.016-.008.025-.012h0a1.852,1.852,0,0,0,1.221-1.9h0a1.7,1.7,0,0,0-.872-1.615h0c-.24-.161-.492-.3-.738-.453h0c-.369-.227-.744-.447-1.1-.686h0a.765.765,0,0,1-.288-.9h0A.746.746,0,0,1,1.8,2.49h0a3.389,3.389,0,0,1,.416-.014h0a.733.733,0,0,1,.778.648h0a3.543,3.543,0,0,0,.108.432h0a.5.5,0,0,0,.559.331h0a.524.524,0,0,0,.46-.5h0a1.887,1.887,0,0,0-1.4-1.964h0c-.1-.022-.126-.062-.13-.165h0A5.44,5.44,0,0,0,2.522.4h0A.454.454,0,0,0,2.034,0h0a.979.979,0,0,0-.105.006Z", transform: "translate(0.128 0.827)" }),
                    React__default['default'].createElement("g", { id: "Group_8-2", "data-name": "Group 8", clipPath: "url(#clip-path)" },
                        React__default['default'].createElement("path", { id: "Fill_6", "data-name": "Fill 6", d: "M0,20.173H14.133V0H0Z", transform: "translate(-4.872 -4.173)" }))),
                React__default['default'].createElement("g", { id: "Group_13", "data-name": "Group 13", transform: "translate(0 11.591)" },
                    React__default['default'].createElement("path", { id: "Stroke_9", "data-name": "Stroke 9", fill: "none", stroke: "#000000", strokeLinecap: "round", strokeMiterlimit: "10", strokeLinejoin: "round", d: "M15.211,7.605A7.606,7.606,0,1,1,7.606,0,7.605,7.605,0,0,1,15.211,7.605Z", transform: "translate(8.551 0.308)" }),
                    React__default['default'].createElement("path", { id: "Stroke_11", "data-name": "Stroke 11", fill: "none", stroke: "#000000", strokeLinecap: "round", strokeMiterlimit: "10", strokeLinejoin: "round", d: "M8.383,15.172a7.689,7.689,0,0,1-.778.04A7.606,7.606,0,1,1,8.806.095", transform: "translate(0.501 0.307)" }))),
            React__default['default'].createElement("path", { id: "Path_18", "data-name": "Path 18", fill: "none", stroke: "#000000", strokeLinecap: "round", strokeMiterlimit: "10", d: "M3.521,0S0,1.021,0,4.283", transform: "translate(3.5 13.5)" }))));
};

var Icon$9 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("g", { id: "Group_4", "data-name": "Group 4", transform: "translate(9 9)" },
            React__default['default'].createElement("path", { id: "Fill_1", "data-name": "Fill 1", fill: "#ffffff", d: "M3.454,3.293,0,3.82,2.5,6.382,1.909,10,5,8.292,8.091,10,7.5,6.382,10,3.82,6.545,3.293,5,0Z" }),
            React__default['default'].createElement("path", { id: "Stroke_2", "data-name": "Stroke 2", fill: "none", stroke: "#000000", strokeMiterlimit: "10", d: "M5,0,6.545,3.293,10,3.82,7.5,6.382,8.091,10,5,8.291,1.909,10,2.5,6.382,0,3.82l3.454-.528Z" })),
        React__default['default'].createElement("g", { id: "Group", transform: "translate(2 2)" },
            React__default['default'].createElement("path", { id: "Stroke_3", "data-name": "Stroke 3", fill: "none", stroke: "#000000", strokeMiterlimit: "10", d: "M0,11C0,4.925,5.373,0,12,0", transform: "translate(0.455 0.648)" }),
            React__default['default'].createElement("path", { id: "Stroke_7", "data-name": "Stroke 7", fill: "none", stroke: "#000000", strokeMiterlimit: "10", d: "M12,0C12,6.075,6.627,11,0,11", transform: "translate(11.455 12.648)" }),
            React__default['default'].createElement("path", { id: "Stroke_11", "data-name": "Stroke 11", fill: "none", stroke: "#000000", strokeMiterlimit: "10", strokeDasharray: "3 3", d: "M0,0C6.627,0,12,4.925,12,11", transform: "translate(11.455 0.648)" }),
            React__default['default'].createElement("path", { id: "Stroke_15", "data-name": "Stroke 15", fill: "none", stroke: "#000000", strokeMiterlimit: "10", strokeDasharray: "3 3", d: "M12,11C5.373,11,0,6.075,0,0", transform: "translate(0.455 12.648)" }))));
};

var Icon$8 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("g", { id: "Group_9", "data-name": "Group 9", transform: "translate(2 2)" },
            React__default['default'].createElement("path", { id: "Stroke_1", "data-name": "Stroke 1", fill: "none", stroke: "#000000", strokeMiterlimit: "10", strokeLinejoin: "round", d: "M24,8,21.07,0H2.929L0,8Z", transform: "translate(0.5 9.286)" }),
            React__default['default'].createElement("path", { id: "Fill_3", "data-name": "Fill 3", fill: "#ffffff", d: "M0,12.671H9.249l3.94-10.1L4.732,0Z", transform: "translate(6.824 0.615)" }),
            React__default['default'].createElement("path", { id: "Stroke_4", "data-name": "Stroke 4", fill: "none", stroke: "#000000", strokeMiterlimit: "10", d: "M9.25,12.671l3.939-10.1L4.732,0,0,12.671Z", transform: "translate(6.823 0.615)" }),
            React__default['default'].createElement("path", { id: "Stroke_6", "data-name": "Stroke 6", fill: "none", stroke: "#000000", strokeMiterlimit: "10", strokeLinecap: "round", d: "M0,.5H15.009", transform: "translate(5.004 12.786)" }),
            React__default['default'].createElement("path", { id: "Stroke_7", "data-name": "Stroke 7", fill: "none", stroke: "#000000", strokeMiterlimit: "10", strokeLinecap: "round", d: "M0,5H24V0H0Z", transform: "translate(0.5 17.286)" }))));
};
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 28 28" }, props),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("clipPath", { id: "clip-path00" },
                React__default['default'].createElement("path", { id: "Clip_6", "data-name": "Clip 6", fill: "none", d: "M0,22.805H23.93V0H0Z", transform: "translate(0 0)" }))),
        React__default['default'].createElement("g", { id: "Group_12", "data-name": "Group 12", transform: "translate(2 3)" },
            React__default['default'].createElement("path", { id: "Stroke_1", "data-name": "Stroke 1", fill: "none", stroke: "#000000", strokeMiterlimit: "10", d: "M17.488,0s-2.94,4.883-5.019,6.81-2.72.438-5.645-.418S0,11.178,0,11.178", transform: "translate(1.419 0.632)" }),
            React__default['default'].createElement("path", { id: "Stroke_3", "data-name": "Stroke 3", fill: "none", stroke: "#000000", strokeMiterlimit: "10", d: "M0,.984,3.757,0l.755,3.52", transform: "translate(15.196 0.617)" }),
            React__default['default'].createElement("path", { id: "Clip_6-2", "data-name": "Clip 6", fill: "none", d: "M0,22.805H23.93V0H0Z", transform: "translate(0 0)" }),
            React__default['default'].createElement("g", { id: "Group_12-2", "data-name": "Group 12", clipPath: "url(#clip-path00)" },
                React__default['default'].createElement("path", { id: "Stroke_5", "data-name": "Stroke 5", fill: "none", stroke: "#000000", strokeMiterlimit: "10", d: "M0,5.07H3.355V0H0Z", transform: "translate(3.652 17.235)" }),
                React__default['default'].createElement("path", { id: "Stroke_7", "data-name": "Stroke 7", fill: "none", stroke: "#000000", strokeMiterlimit: "10", d: "M0,8.16H3.355V0H0Z", transform: "translate(10.849 14.145)" }),
                React__default['default'].createElement("path", { id: "Stroke_8", "data-name": "Stroke 8", fill: "none", stroke: "#000000", strokeMiterlimit: "10", d: "M0,14.163H3.355V0H0Z", transform: "translate(17.828 8.142)" }),
                React__default['default'].createElement("g", { id: "Group_11", "data-name": "Group 11", transform: "translate(0 21.805)" },
                    React__default['default'].createElement("path", { id: "Fill_9", "data-name": "Fill 9", fill: "#ffffff", d: "M0,.5H23.93", transform: "translate(0 0)" }),
                    React__default['default'].createElement("path", { id: "Stroke_10", "data-name": "Stroke 10", fill: "none", stroke: "#000000", strokeMiterlimit: "10", d: "M0,.5H23.93", transform: "translate(0 0)" }))))));
};
