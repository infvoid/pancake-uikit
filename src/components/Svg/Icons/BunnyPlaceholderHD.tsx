...
const Icon: React.FC<SvgProps> = (props) => {
    return (
        <Svg viewBox="0 0 100 100" {...props} color="#FEC300">
            <g>
                <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="25.8238" y1="40.8001" x2="70.1398" y2="40.8001"
                ...
                <path fill="currentColor" d="M50.6,14.4l-24.3,15l-0.7,0.4l-0.7,0.4l0.9,17l0.8,15.1l0.8,16c0.3-0.1,0.5-0.3,0.5-0.6V63.9
		...
		L27.9,46l0,0c-0.2-0.1-0.3-0.3-0.3-0.6V30.6c3-2.1,22.6-15.9,33.5-11.1C72,24.6,48.2,36.4,42.8,38.9z" />
                ...
                <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="14.3287" y1="52.896" x2="59.5795" y2="52.896"
                    gradientTransform="matrix(1 -6.981316e-04 6.981316e-04 1 -0.941 5.5778)">
                    <stop offset="0" stopColor="#FEC300" />
                    <stop offset="1" stopColor="#FEC300" />
                </linearGradient>
                <path fill="currentColor" d="M58.7,93.6c0,0.4-0.3,0.6-0.7,0.7c-0.1,0-0.3,0-0.4-0.1l-14.2-7.4c-0.2-0.1-0.4-0.3-0.4-0.6V70.6
		...
		L58.4,79L58.7,93.6z" />
                ...
                <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="14.4384" y1="21.0223" x2="89.9294" y2="21.0223"
                    gradientTransform="matrix(1 -6.981316e-04 6.981316e-04 1 -0.941 5.5778)">
                    <stop offset="0" stopColor="#FEC300" />
                    <stop offset="1" stopColor="#FEC300" />
                </linearGradient>
                <path fill="currentColor" d="M88.9,23.6c-1.1,6.2-8.8,12.1-16.3,16.5c-4.7,2.7-9.5,5.2-14.5,7.3l-0.2,0.1c-0.1,0-0.1,0-0.2,0h-0.1l-0.5-0.2
		...
		C87,14.6,89.7,19.2,88.9,23.6z" />
                ...
                <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="70.6806" y1="57.3273" x2="87.3573" y2="57.3273"
                    gradientTransform="matrix(1 -6.981316e-04 6.981316e-04 1 -0.941 5.5778)">
                    <stop offset="0" stopColor="#FEC300" />
                    <stop offset="1" stopColor="#FEC300" />
                </linearGradient>
                <path fill="currentColor" d="M72.1,75.9l13.4-6.3c0.6-0.3,0.9-0.8,0.9-1.5V51.2c0-0.9-0.7-1.6-1.6-1.6c-0.3,0-0.5,0.1-0.7,0.2l-13.5,7.1
