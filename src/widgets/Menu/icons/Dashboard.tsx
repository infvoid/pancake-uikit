    ...
    <Svg viewBox="0 0 22 22" {...props}>
      <g transform="translate(0.5 0.5)">
        <g>
          ...
          <path fill={fillColor} stroke={textColor} strokeMiterlimit="10" d="M2.507,13.75H.389A.408.408,0,0,1,0,13.326V.424A.408.408,0,0,1,.389,0H2.507A.408.408,0,0,1,2.9.424v12.9A.408.408,0,0,1,2.507,13.75Z" transform="translate(9.167 4.583)" />
          <path fill={fillColor} stroke={textColor} strokeMiterlimit="10" d="M2.507,10.083H.389A.426.426,0,0,1,0,9.628V.455A.426.426,0,0,1,.389,0H2.507A.426.426,0,0,1,2.9.455V9.628A.426.426,0,0,1,2.507,10.083Z" transform="translate(14.667 8.25)" />
